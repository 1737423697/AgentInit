...
class CheckPlans(Action):
    def __init__(self, name="Check Plan", context=None, llm_name=None):
    ...
    async def run(self, context, history=''):
        ...
        prompt = PROMPT_TEMPLATE.format(context=context, plan=plan, roles=roles, format_example=FORMAT_EXAMPLE, history=history)
